...
- `uv run arb ui [--tickers ... | --top N] [--poly-top N | --poly-slugs ...] [--pairs-top N] [--port 8080] [--no-record]` serves the terminal UI at http://127.0.0.1:8080 (records while it runs unless --no-record); terminal commands: `DES`, `PAIRS`, `ARB`
